...
class AppFullScreenHeaderCell: BaseTableCell {
    ...
    private let todayCollectionCell = TodayFeedCell()
    ...
    override func initialSetup() {
        ...
        closeButton.makeConstraints(top: topAnchor, trailing: trailingAnchor, padding: .init(top: 4, left: 0, bottom: 0, right: 4), size: .init(width: 60, height: 60))
    }
}
